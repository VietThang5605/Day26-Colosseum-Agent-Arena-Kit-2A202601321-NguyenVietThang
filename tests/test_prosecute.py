...
def test_starter_end_to_end_against_the_full_fixture_set(labelled_fixtures):
    ...
    # the invariant that matters: zero false claims, whatever the recall
    assert report["false_claim_rate"] == 0.0
    # recall progresses as hooks are implemented (starter was 1 of 17); this
    # assertion is a floor, not a ceiling — raise it as more hooks land
    ...
    # class the kit's deterministic gate-1 cannot verify is pure recoil risk
